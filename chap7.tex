...
\key{$\mathbf{X \oplus Y}$} $X \oplus Y = \{0x | x \in X\} \cup \{1x | x \in
Y\}$.
...
\key{Proposition 7.4.} For all $k \ge 0$, $\Sigma_k^P \cup \Pi_k^P \subseteq
\Delta_{k+1}^P \subseteq \Sigma_{k+1}^P \cap \Pi_{k+1}^P$.

\key{Proposition 7.5.} PH $\subseteq$ PSPACE, where PH= $\cup \{\Sigma^P_k|k \ge
0\}$.
